...
public class CliPodBridge implements PodBridge {
    ...
    private CliPodBridge(String name, Process forwarder, String port, @Nullable Process debugForwarder, @Nullable String debugPort) {
        this.name = name;
    ...
    public static CliPodBridge establish(String podName, String localPort, String targetPort, @Nullable String localDebugPort, @Nullable String appDebugPort) {
        try {
            ...
            return new CliPodBridge(podName, process, localPort, debugProcess, localDebugPort);
        } catch (IOException e) {
